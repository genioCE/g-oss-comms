# Comms/Collab — Mattermost + Matrix/Element
...
**Integrates with:** g-oss-security (SSO), bots to CI/observability.
    ...
    - Helm chart skeleton is under `charts/g-oss-comms` (namespace defaults to `platform`).
    ...
    - For Helm, set values in `charts/g-oss-comms/values.yaml`.
